 ...
 * @desc    Register new user (vendor, supplier, transporter, admin)
 * @access  Public
 */
router.post('/register', async (req, res) => {
  try {
    ...
    // Validate role
    const validRoles = ['vendor', 'supplier', 'transporter', 'admin'];
...
router.put('/profile', auth, async (req, res) => {
  try {
    const { name, businessName, businessAddress, location } = req.body;
